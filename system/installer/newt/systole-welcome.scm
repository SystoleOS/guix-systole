...
(define logo-width (make-parameter 47))
(define logo-height (make-parameter 12))
...
(define* (run-systole-welcome-page logo #:key pci-database)
  "Run a systole-welcome page with the given textual LOGO displayed at the center of
...
first?"))
  ...
  (run-menu-page
   (G_ "GNU Systole install")
   (G_ "Welcome to the GNU Systole system installer!
   ...
   `((,(G_ "Graphical install using a terminal based interface")
     ...
     (,(G_ "Install using the shell based process")
      ...
      ,(lambda ()
         ...
         (system* "chvt" "3")
         (run-systole-welcome-page logo #:pci-database pci-database)))
     (,(G_ "Reboot")
      .
      ,(lambda ()
         (newt-finish)
