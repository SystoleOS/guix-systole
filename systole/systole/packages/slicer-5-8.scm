...
;;
(define-module (systole packages slicer-5-8)
  ...
  #:use-module ((systole packages slicer-factory)
                #:select (slicerexecutionmodel
                          ...
                          (make-slicer-cli-module . factory:make-slicer-cli-module)))
...
;; slicer-factory), with the 5.8 base package, version string, and PythonQt
...
(define (make-slicer-scripted-module . args)
  (apply factory:make-slicer-scripted-module
         #:slicer slicer-5.8
         #:slicer-version "5.8"
         args))

(define (make-slicer-cli-module . args)
  (apply factory:make-slicer-cli-module
         #:slicer slicer-5.8
         #:slicer-version "5.8"
         args))
