    ...
    (source
     (origin
       ...
       (patches (search-patches
                 ...
                 "0018-ENH-Add-LINK<sub>DIRECTORIES</sub>-support-to-SlicerMacroBuild.patch"
                 "0019-ENH-Add-Slicer<sub>Libs</sub><sub>INCLUDE</sub><sub>DIRS</sub>-to-SlicerMacroBuild.patch"
                 ...
                 "0024-COMP-Fix-empty-Slicer<sub>INSTALL</sub><sub>QTLOADABLEMODULES</sub><sub>INCL.patch</sub>"
                 "0025-COMP-Add-qSlicerBaseQTCore-to-standalone-module-widg.patch"
                 "0026-COMP-Add-EXTRA<sub>MODULE</sub><sub>LIB</sub><sub>DIRS</sub>-to-module-build-macro.patch"
                 "0027-COMP-Add-qMRMLWidgets-to-standalone-module-widgets-l.patch"
                 "0028-COMP-Add-Slicer<sub>GUI</sub><sub>LIBRARY</sub>-fallback-to-SlicerMacroB.patch"
                 ...
                 "0032-COMP-Add-Slicer<sub>INSTALL</sub><sub>LIB</sub><sub>DIR</sub>-to-QtLibrary-link-se.patch"
                 ...
                 "0035-COMP-Install-qrcc.py-and-fix-Slicer<sub>QRCC</sub><sub>SCRIPT</sub>-for-.patch"
                 "0036-COMP-Ensure-PYTHON<sub>EXECUTABLE</sub>-is-set-in-slicerFuncti.patch"
                 "0037-COMP-Fix-module-install-dir-variables-for-install-tr.patch"
                 "0038-COMP-Bridge-Python3-target-to-legacy-PYTHON<sub>LIBRARIE.patch</sub>"
                 "0039-COMP-Fix-Slicer<sub>BINARY</sub><sub>DIR</sub>-usage-and-expose-QTSCRIPT.patch"
                 ...
                 "0043-COMP-Bake-SlicerExecutionModel<sub>DIR</sub>-into-install-tree.patch"
                 "0044-COMP-Expose-MRMLCLI<sub>INCLUDE</sub><sub>DIRS</sub>-in-install-tree-Sli.patch"
                 "0045-ENH-Read-SLICER<sub>ADDITIONAL</sub><sub>MODULE</sub><sub>PATHS</sub>-env-var-in-a.patch"
                 "0046-ENH-Extend-LD<sub>LIBRARY</sub><sub>PATH</sub>-and-PYTHONPATH-from-SLICE.patch"
                 ...
                 "0052-ENH-Execute-SLICER<sub>INIT</sub><sub>DIR</sub>-init.py-after-slicerqt.p.patch"
                 "0053-COMP-Expose-extension-build-vars-in-install-tree-Sli.patch"
                 "0054-ENH-Auto-discover-Guix-installed-modules-via-GUIX<sub>EN.patch</sub>"
                 "0055-ENH-Bake-GLEW-store-paths-into-install-tree-SlicerIn.patch"
                 "0056-COMP-Install-CXX-test-templates-and-expose-Slicer<sub>CX.patch</sub>"
                 "0057-ENH-Add-slicer-launch-wrapper-and-set-Slicer<sub>LAUNCH</sub><sub>.patch</sub>"
                 "0058-COMP-Expose-Slicer<sub>PYTHON</sub><sub>MODULE</sub><sub>TEST</sub><sub>TEMPLATES</sub><sub>DIR</sub>-.patch"
                 ...
                 "0061-COMP-Fix-vtkAddon<sub>LIB</sub><sub>DIR</sub>-and-add-vtk-private-header.patch"
                 ))))
    ...
    (arguments
     (list #:tests? #f
           ...
           #~(list
              ...
              "-DCMAKE<sub>BUILD</sub><sub>TYPE</sub>:STRING=Release"
              "-DCMAKE<sub>CXX</sub><sub>COMPILER</sub>:STRING=g++"
              "-DCMAKE<sub>C</sub><sub>COMPILER</sub>:STRING=gcc"
              "-DCMAKE<sub>CXX</sub><sub>STANDARD</sub>:STRING=17"

;; Compiler flags
"-DCMAKE<sub>EXE</sub><sub>LINKER</sub><sub>FLAGS</sub>=-pthread"
"-DSlicer<sub>SUPERBUILD</sub>:BOOL=OFF"
"-DBUILD<sub>TESTING</sub>:BOOL=OFF"
"-DBUILD<sub>SHARED</sub><sub>LIBS</sub>:BOOL=ON"
"-DSlicer<sub>BUILD</sub><sub>EXTENSIONMANAGER</sub><sub>SUPPORT</sub>:BOOL=OFF"
"-DSlicer<sub>DONT</sub><sub>USE</sub><sub>EXTENSION</sub>:BOOL=ON"
"-DSlicer<sub>REQUIRED</sub><sub>QT</sub><sub>VERSION</sub>:STRING=5"
;; "-DSlicer<sub>BUILD</sub><sub>DICOM</sub><sub>SUPPORT</sub>:BOOL=$(usex DICOM ON OFF)"
"-DSlicer<sub>BUILD</sub><sub>ITKPython</sub>:BOOL=OFF"

;; CLI — support library only; CLI module executables are
;; built as separate packages via make-slicer-cli-module.
"-DSlicer<sub>BUILD</sub><sub>CLI</sub>:BOOL=OFF"
"-DSlicer<sub>BUILD</sub><sub>CLI</sub><sub>SUPPORT</sub>:BOOL=ON"
;; Tell Slicer where to find SlicerExecutionModel.  The install-tree
;; SlicerExecutionModelConfig.cmake is installed at <sem>/lib/.
(string-append "-DSlicerExecutionModel<sub>DIR</sub>="
...
;; QT
"-DSlicer<sub>BUILD</sub><sub>QTLOADABLEMODULES</sub>:BOOL=OFF"
"-DSlicer<sub>BUILD</sub><sub>QTSCRIPTEDMODULES</sub>:BOOL=OFF"
"-DSlicer<sub>BUILD</sub><sub>QT</sub><sub>DESIGNER</sub><sub>PLUGINS</sub>:BOOL=OFF" ;Turn ON?
"-DSlicer<sub>USE</sub><sub>QtTesting</sub>:BOOL=OFF"
"-DSlicer<sub>USE</sub><sub>SlicerITK</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>CTKAPPLAUNCHER</sub>:BOOL=OFF"
"-DSlicer<sub>BUILD</sub><sub>WEBENGINE</sub><sub>SUPPORT</sub>:BOOL=OFF"
(string-append "-DQt5<sub>DIR</sub>:PATH="
               #$(this-package-input "qtbase"))
;; "-DSlicer<sub>USE</sub><sub>SimpleITK</sub>:BOOL=OFF"
;; "-DSlicer<sub>VTK</sub><sub>RENDERING</sub><sub>BACKEND</sub>:STRING=OpenGL2"
"-DSlicer<sub>VTK</sub><sub>VERSION</sub><sub>MAJOR</sub>:STRING=9"
"-DSlicer<sub>BUILD</sub><sub>vtkAddon</sub>:BOOL=OFF" ;This should be OFF, so Slicer uses the system installed one.

"-DSlicer<sub>INSTALL</sub><sub>DEVELOPMENT</sub>:BOOL=ON"
"-DSlicer<sub>INSTALL</sub><sub>DEVELOPMENT</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>TBB</sub>:BOOL=ON"

;; "-DCTK<sub>INSTALL</sub><sub>QTPLUGIN</sub><sub>DIR</sub>:STRING=/usr/lib64/qt5/plugins"
;; "-DQT<sub>PLUGINS</sub><sub>DIR</sub>:STRING=/usr/lib64/designer"
;; "-DSlicer<sub>QtPlugins</sub><sub>DIR</sub>:STRING=/usr/lib64/designer"
;; "-DjqPlot<sub>DIR</sub>:STRING=/usr/share/jqPlot"
;; "-DSlicer<sub>VTK</sub><sub>WRAP</sub><sub>HIERARCHY</sub><sub>DIR</sub>:STRING=#{$\x7b;BUILD<sub>DIR\x7d</sub>;}#"
;; "-DSlicer<sub>USE</sub><sub>SimpleITK</sub>:BOOL=OFF"
"-DSlicer<sub>BUILD</sub><sub>DICOM</sub><sub>SUPPORT</sub>:BOOL=ON"

;; Python
;; "-DPython3<sub>INCLUDE</sub><sub>DIR</sub>:FILEPATH="
;; "-DPython3<sub>LIBRARY</sub>:FILEPATH="
;; "-DPython3<sub>EXECUTABLE</sub>:FILEPATH="
"-DVTK<sub>WRAP</sub><sub>PYTHON</sub>:BOOL=OFF"
"-DSlicer<sub>USE</sub><sub>PYTHONQT</sub>:BOOL=OFF"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>python</sub>:BOOL=OFF"

;; Other required external modules. These are required, otherwise Slicer tries to download them.
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>bzip2</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>CTK</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>TBB</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>teem</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>QT</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>curl</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>DCMTK</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>ITK</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>LibArchive</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>LibFFI</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>LZMA</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>RapidJSON</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>sqlite</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>VTK</sub>:BOOL=ON"
"-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>zlib</sub>:BOOL=ON"

   ;; Hack to fix error "Variable Slicer<sub>WC</sub><sub>LAST</sub><sub>CHANGED</sub><sub>DATE</sub> is expected to be defined."
   "-DSlicer<sub>WC</sub><sub>LAST</sub><sub>CHANGED</sub><sub>DATE</sub>:STRING=2025-3-2 19:58:36 -0500")
\#:out-of-source? #t
\#:phases
...
(setenv "CMAKE<sub>PREFIX</sub><sub>PATH</sub>"
        (string-append (assoc-ref inputs "vtkaddon")
                       "/lib/cmake:"
                       (or (getenv "CMAKE<sub>PREFIX</sub><sub>PATH</sub>")
                           ""))) #t))
                        ...
                        (add-after 'install 'patch-runpath
                          ...
                          ;; them without LD<sub>LIBRARY</sub><sub>PATH</sub>.
                        ...
                        (add-after 'install-slicer-symlink 'install-slicer-launch
                          ...
                          ;; that populates LD<sub>LIBRARY</sub><sub>PATH</sub> from the colon-separated
                          ;; SLICER<sub>ADDITIONAL</sub><sub>MODULE</sub><sub>PATHS</sub> entries and then execs
                          ;; its arguments.  Used as Slicer<sub>LAUNCH</sub><sub>COMMAND</sub> in the
                          ...
                          ;; SLICER<sub>ADDITIONAL</sub><sub>MODULE</sub><sub>PATHS</sub> to include their
                          ...
                          (lambda\* (#:key outputs #:allow-other-keys)
                            (let\* ((out (assoc-ref outputs "out"))
                              ...
                              (call-with-output-file script
                                (lambda (port)
                                  (display "#!/bin/sh\n" port)
                                  (display "# slicer-launch: extend LD<sub>LIBRARY</sub><sub>PATH</sub> from\n" port)
                                  (display "# SLICER<sub>ADDITIONAL</sub><sub>MODULE</sub><sub>PATHS</sub> then exec args.\n" port)
                                  (display "IFS=:\n" port)
                                  (display "for \_d in $SLICER<sub>ADDITIONAL</sub><sub>MODULE</sub><sub>PATHS</sub>; do\n" port)
                                  (display "  LD<sub>LIBRARY</sub><sub>PATH</sub>=\\"$_d${LD<sub>LIBRARY</sub><sub>PATH</sub>:+:$LD_LIBRARY_PATH}\"\n" port)
                                      (display "done\n" port)
                                      (display "unset IFS\n" port)
                                      (display "export LD_LIBRARY_PATH\n" port)
                                      (display "exec \"$@\\"\n" port)))
                              (chmod script #o755))))
                        (add-after 'install-slicer-launch 'install-extra-vtk-headers
                          ;; VTK's cmake build system does not install
                          ;; vtkOpenGLResourceFreeCallback.h because it is not
                          ;; listed in Rendering/OpenGL2/CMakeLists.txt HEADERS.
                          ;; Slicer extensions (e.g. Slicer-Liver) include it
                          ;; directly.  Install it under include/vtk-X.Y* which
                          ;; is added to Slicer<sub>Libs</sub><sub>INCLUDE</sub><sub>DIRS</sub> in patch 0061.
                          (lambda\* (#:key inputs outputs #:allow-other-keys)
                            (let\* ((out (assoc-ref outputs "out"))
                                   ;; Mirror vtk-slicer's include subdirectory name.
                                   (dest (string-append out "/include/vtk-9.2")))
                              (mkdir-p dest)
                              (copy-file
                               (assoc-ref inputs "vtkOpenGLResourceFreeCallback.h")
                               (string-append dest "/vtkOpenGLResourceFreeCallback.h")))))
                        )))
(inputs
 (list libxt
       dcmtk
...
proj
    ...
    (native-inputs (list patchelf pkg-config
                         ;; Private VTK header not installed by VTK's cmake rules;
                         ;; copied into include/vtk-X.Y/ by install-extra-vtk-headers phase.
                         (local-file "extra-headers/vtkOpenGLResourceFreeCallback.h"
    ...
    ;; collects those directories into SLICER<sub>ADDITIONAL</sub><sub>MODULE</sub><sub>PATHS</sub> when
    ;; module packages share a profile with slicer-5.8.  Slicer reads this
    ;; variable directly (patch 0045) and extends LD<sub>LIBRARY</sub><sub>PATH</sub> from it
    ...
    ;; after slicerqt.py).  Patches 0051-0052 read SLICER<sub>INIT</sub><sub>DIR</sub> for this.
    (native-search-paths
     (list (search-path-specification
            (variable "SLICER<sub>ADDITIONAL</sub><sub>MODULE</sub><sub>PATHS</sub>")
            (files '("lib/Slicer-5.8/qt-loadable-modules"
                     "lib/Slicer-5.8/cli-modules")))
           (search-path-specification
            (variable "SLICER<sub>INIT</sub><sub>DIR</sub>")
  ...
  (package
   ...
   (arguments
    (list
     ...
     #~(list
        "-DBUILD<sub>TESTING</sub>:BOOL=OFF"
        "-DSlicerExecutionModel<sub>USE</sub><sub>UTF8</sub>:BOOL=ON"
        ;; Install development files (GenerateCLP binary, cmake config,
        ;; headers) so downstream packages can use GenerateCLP.
        "-DSlicerExecutionModel<sub>INSTALL</sub><sub>NO</sub><sub>DEVELOPMENT</sub>:BOOL=OFF"
     ...
     #~(modify-phases %standard-phases
         (add-after 'install 'fix-rpath
           ...
           ;; libstdc++/libgcc<sub>s</sub> paths that CMake's linker already recorded.
           (lambda\* (#:key outputs #:allow-other-keys)
               ...
               (for-each
                (lambda (bin)
                  (when (file-exists? bin)
                    (let\* ((pipe (open-pipe\* OPEN<sub>READ</sub> "patchelf" "&#x2013;print-rpath" bin))
...
;; do NOT call find<sub>package</sub>(Slicer) and therefore do not need VTK, CTK, Qt, or
;; any other Slicer dependency.  Their CMakeLists.txt files have no
;; cmake<sub>minimum</sub><sub>required</sub> / project() preamble (they assumed being
;; add<sub>subdirectory</sub>()-d from the Slicer root), so each module requires a
;; small preamble patch.
;;
;; Executables are installed to lib/Slicer-5.8/cli-modules so that Guix
;; profile-based search via SLICER<sub>ADDITIONAL</sub><sub>MODULE</sub><sub>PATHS</sub> picks them up.
  ...
  (package
   ...
   (arguments
    (list #:tests? #f
          ...
          #~(append
             (list "-DCMAKE<sub>BUILD</sub><sub>TYPE</sub>:STRING=Release"
                   "-DBUILD<sub>TESTING</sub>:BOOL=OFF"
                   ...
                   "-DSlicerExecutionModel<sub>DEFAULT</sub><sub>CLI</sub><sub>INSTALL</sub><sub>RUNTIME</sub><sub>DESTINATION</sub>=lib/Slicer-5.8/cli-modules"
                   "-DSlicerExecutionModel<sub>DEFAULT</sub><sub>CLI</sub><sub>INSTALL</sub><sub>LIBRARY</sub><sub>DESTINATION</sub>=lib/Slicer-5.8/cli-modules"
                   ;; SlicerExecutionModelInstallConfig.cmake does not set the
                   ;; **\_OUTPUT<sub>DIRECTORY</sub> vars (build-tree paths).  SEMMacroBuildCLI.cmake
                   ;; falls back to SlicerExecutionModel<sub>CLI</sub><sub>\*</sub><sub>OUTPUT</sub><sub>DIRECTORY</sub>, so set
                   ;; those to simple relative paths (cmake expands them from binary dir).
                   "-DSlicerExecutionModel<sub>CLI</sub><sub>RUNTIME</sub><sub>OUTPUT</sub><sub>DIRECTORY</sub>=bin"
                   "-DSlicerExecutionModel<sub>CLI</sub><sub>LIBRARY</sub><sub>OUTPUT</sub><sub>DIRECTORY</sub>=lib"
                   "-DSlicerExecutionModel<sub>CLI</sub><sub>ARCHIVE</sub><sub>OUTPUT</sub><sub>DIRECTORY</sub>=lib"
                   ...
                   (string-append "-DSlicerExecutionModel<sub>DEFAULT</sub><sub>CLI</sub><sub>LIBRARY</sub><sub>WRAPPER</sub><sub>CXX</sub>="
                   ...
                   (string-append "-DGenerateCLP<sub>DIR</sub>="
                                  #$slicerexecutionmodel "/lib/GenerateCLP")
                   (string-append "-DModuleDescriptionParser<sub>DIR</sub>="
                                  #$slicerexecutionmodel "/lib/ModuleDescriptionParser")
                   (string-append "-DTCLAP<sub>DIR</sub>="
                                  #$slicerexecutionmodel "/lib/tclap")
                   (string-append "-DITK<sub>DIR</sub>="
                  ...
                  (let\* ((source (getcwd))
                    ...
                    (apply invoke "cmake"
                           "-S" (string-append source "*Modules/CLI*"
                                               #$module-subdir)
                           "-B" "build"
                           (string-append "-DCMAKE<sub>INSTALL</sub><sub>PREFIX</sub>=" out)
                           ...
                           (string-append "-DSlicerExecutionModel<sub>EXTRA</sub><sub>INCLUDE</sub><sub>DIRECTORIES</sub>="
                                          source "/Base/CLI;"
                                          source "/Libs/vtkITK")
                           configure-flags)
                    (chdir "build")
...
;;;
;;; Python-enabled Slicer — canonical public variant
;;;

;; slicer-5.8 is the canonical public Slicer package.  Python support is a
;; hard requirement: PythonQt (via CTK), VTK Python wrappers, and Qt-scripted
;; modules are all enabled.  vtk-slicer, ctk, vtkaddon, and itk-slicer are
;; already Python-enabled (their canonical names = Python variants after the
;; vtk/ctk/itk rename).
;;
;; All standalone loadable modules (slicer-**-5.8) are built against this
;; package so their build-time and runtime ABIs are identical.  Python wrapper
;; generation in each module's CMake build is handled by SlicerConfig.cmake,
;; which unconditionally sets Slicer<sub>USE</sub><sub>PYTHONQT</sub>=ON.
;;
;; ITK Python wrapping (Slicer<sub>BUILD</sub><sub>ITKPython</sub>) remains OFF until
...
(define-public slicer-5.8
  (package
     ...
     (substitute-keyword-arguments (package-arguments %slicer-5.8)
       ((#:configure-flags flags)
        #~(append
           (list
            ...
            ;; vtkAddon<sub>CMAKE</sub><sub>DIR</sub> is used at the top of Slicer's CMakeLists.txt
            ;; (line ~803) before any find<sub>package</sub>(vtkAddon) runs, so it must be
            ;; pre-set as a cache variable.
            (string-append "-DvtkAddon<sub>CMAKE</sub><sub>DIR</sub>="
                           #$(this-package-input "vtkaddon") "/lib/cmake"))
           (filter (lambda (f)
                     (not (member f '("-DVTK<sub>WRAP</sub><sub>PYTHON</sub>:BOOL=OFF"
                                      "-DSlicer<sub>USE</sub><sub>PYTHONQT</sub>:BOOL=OFF"
                                      "-DSlicer<sub>USE</sub><sub>SYSTEM</sub><sub>python</sub>:BOOL=OFF"
                                      "-DSlicer<sub>BUILD</sub><sub>QTSCRIPTEDMODULES</sub>:BOOL=OFF"))))
                   #$flags)))
       ((#:phases phases)
        #~(modify-phases #$phases
            ;; Extend CMAKE<sub>PREFIX</sub><sub>PATH</sub> to include pythonqt-commontk.
            ...
            ;; requiring LD<sub>LIBRARY</sub><sub>PATH</sub>.
    ...
    (inputs
     ...
     ;; Only python and pythonqt-commontk need to be added explicitly.
    ...
    ;; by slicer-all-5.8 instead.  Keeping them in slicer-5.8 would cause
    ;; &#x2013;without-tests=<any-of-them> to cascade through slicer-5.8 into every
    ;; loadable module (which all use slicer-5.8 as a build input), producing
    ;; duplicate derivations.  Placing the runtime deps only in the meta-package
    ;; breaks the cascade cleanly.
    ;;
    ;; vtk-slicer, ctk, and vtkaddon ARE propagated so that their Python
    ;; directories land in the Guix profile symlink farm:
    ;;   vtk-slicer/lib/python3.11/site-packages  → \`import vtk\`
    ;;   ctk/bin/Python                            → \`import ctk\`, \`import qt\`
    ;;   vtkaddon/lib/python3.11/site-packages     → vtkAddon Python wrappers
    ;; SLICER<sub>PYTHONPATH</sub> (native-search-path) then collects all three via its
    ;; \`lib/python3.11/site-packages\` and \`bin/Python\` patterns, and Slicer
    ;; prepends SLICER<sub>PYTHONPATH</sub> to PYTHONPATH at startup (patch 0046/0048).
    ;;
    ...
    ;; UseSlicer.cmake calls find<sub>package</sub>(Qt5 COMPONENTS &#x2026; UiTools XmlPatterns
    ;; Svg Multimedia X11Extras Qml LinguistTools &#x2026;) for all modules baked into
    ;; Slicer<sub>REQUIRED</sub><sub>QT</sub><sub>MODULES</sub> at build time.  Each component lives in a
    ;; separate Guix package, so all must be in GUIX<sub>ENVIRONMENT</sub>.
    ;; VTK<sub>DIR</sub>, ITK<sub>DIR</sub>, CTK<sub>DIR</sub>, vtkAddon<sub>DIR</sub>, Qt5<sub>DIR</sub>, GLEW\_** and Python3<sub>\*</sub>
...
(native-search-paths
 (list ;; Accumulate every package in the profile as a cmake prefix.
       ...
       ;; derive find<sub>path</sub>/find<sub>library</sub> search roots from CMAKE<sub>PREFIX</sub><sub>PATH</sub>,
       ;; so transitive deps re-discovered by find<sub>package</sub>(ITK)/find<sub>package</sub>(VTK)
       ...
       ;; CMAKE<sub>PREFIX</sub><sub>PATH</sub> native-search-path declaration (files: "").
       (search-path-specification
        (variable "CMAKE<sub>PREFIX</sub><sub>PATH</sub>")
        (files '("")))
       (search-path-specification
        (variable "SLICER<sub>ADDITIONAL</sub><sub>MODULE</sub><sub>PATHS</sub>")
        (files '("lib/Slicer-5.8/qt-loadable-modules"
                 ...
                 "lib/Slicer-5.8/cli-modules")))
       (search-path-specification
        (variable "SLICER<sub>PYTHONPATH</sub>")
        ;; bin/Python: .py wrappers installed by slicer-5.8 and ctk
        ;;   (ctk/, qt/ packages) — contributed via ctk's own
        ;;   SLICER<sub>PYTHONPATH</sub> native-search-path.
        ;; lib/Slicer-5.8: C-extension .so (MRMLCorePython, …).
        ;; lib/python3.11/site-packages: numpy, vtk, vtkAddon, user pkgs.
        (files '("bin/Python"
                 "lib/Slicer-5.8"
                 "lib/python3.11/site-packages")))
       ;; PYTHONPATH mirrors SLICER<sub>PYTHONPATH</sub> so that a plain \`python3\`
...
;; Do NOT use (inherit slicer-5.8) in the packages produced here: Guix forbids
...
;;
;; All modules are built against the canonical slicer-5.8 (Python-enabled).
;; Python wrapping (VTK + PythonQt) is enabled by SlicerConfig.cmake, which
;; unconditionally sets Slicer<sub>USE</sub><sub>PYTHONQT</sub>=ON; each module therefore produces
...
(define** (make-slicer-loadable-module
  ...
  (package
    ...
    (list #:tests? #f
          ...
          #~(append
             (list "-DCMAKE<sub>BUILD</sub><sub>TYPE</sub>:STRING=Release"
                   ...
                   ;; Avoids CMAKE<sub>PREFIX</sub><sub>PATH</sub> list-separator ambiguity
                   ;; (CMake -D variables use ";" while env vars use ":").
                   (string-append "-DSlicer<sub>DIR</sub>="
                                  #$slicer-5.8
                                  "*lib/Slicer-5.8")
                   ;; UseSlicer.cmake calls find<sub>package</sub>(PythonQt) which uses
                   ;; PYTHONQT<sub>INSTALL</sub><sub>DIR</sub> as a hint to find PythonQt.h and set
                   ;; PYTHONQT<sub>INCLUDE</sub><sub>DIR</sub>.  Without this hint, find<sub>path</sub> may
                   ;; not locate PythonQt.h, leaving PYTHONQT<sub>INCLUDE</sub><sub>DIR</sub> empty
                   ;; and the include<sub>directories</sub>() call in UseSlicer a no-op.
                   (string-append "-DPYTHONQT<sub>INSTALL</sub><sub>DIR</sub>="
                                  #$pythonqt-commontk))
             #$extra-configure-flags)
          #:phases
          #~(modify-phases %standard-phases
   ...
   ;; not just slicer-5.8 itself.  We therefore start from slicer-5.8's input
   ;; list and prepend slicer-5.8 so cmake can locate SlicerConfig.cmake.
   ...
   (inputs (fold (lambda (pkg acc)
                 ...
                 (modify-inputs (package-inputs slicer-5.8)
                   (prepend slicer-5.8))
                 extra-inputs))
   ;; Propagate slicer-5.8 so "guix shell slicer-<name>-5.8" gives a usable
...
(define-public slicer-terminologies-5.8
  (make-slicer-loadable-module
   ...
   #:patches (list "terminologies/0001-ENH-Add-missing-dependencies-for-standalone-build-of.patch"
                   "terminologies/0002-COMP-Restore-Slicer<sub>INSTALL</sub><sub>QTLOADABLEMODULES</sub><sub>LIB</sub><sub>DI.patch</sub>")
...
@file{Modules/Loadable/Terminologies} subtree of the Slicer source tree."
   ...
   #:extra-configure-flags
   #~(list (string-append "-DRapidJSON<sub>DIR</sub>="
                          #$rapidjson
                          "/lib/cmake/RapidJSON"))))
...
(define-public slicer-subjecthierarchy-5.8
  (make-slicer-loadable-module
   ...
   #:patches (list "subjecthierarchy/0001-ENH-Add-standalone-build-support-for-SubjectHierarch.patch"
                   ...
                   ;; Fix ${Slicer<sub>BINARY</sub><sub>DIR</sub>} → ${CMAKE<sub>BINARY</sub><sub>DIR</sub>} in SubjectHierarchyPlugins
                   ;; so the standalone build uses the current project's binary tree.
                   "subjecthierarchy/0005-COMP-Fix-Slicer<sub>BINARY</sub><sub>DIR</sub>-usage-in-SubjectHierarchy.patch"
                   ...
                   ;; SubjectHierarchyPlugins/\_<sub>init</sub>\_<sub>.py</sub> so that the merged
...
the Slicer source tree."
   ...
   #~(list
      ...
      (string-append
       "-DqSlicerTerminologiesModuleWidgets<sub>INCLUDE</sub><sub>DIRS</sub>="
      ...
      (string-append
       "-DvtkSlicerTerminologiesModuleLogic<sub>INCLUDE</sub><sub>DIRS</sub>="
       #$slicer-terminologies-5.8
      ...
      (string-append
       "-DEXTRA<sub>MODULE</sub><sub>LIB</sub><sub>DIRS</sub>="
       #$slicer-terminologies-5.8
       "/lib/Slicer-5.8/qt-loadable-modules"))))
...
@file{Modules/Loadable/Colors} subtree of the Slicer source tree."
   ...
   #~(list
      ...
      (string-append
       "-DqSlicerSubjectHierarchyModuleWidgets<sub>INCLUDE</sub><sub>DIRS</sub>="
      ...
      (string-append
       "-DvtkSlicerSubjectHierarchyModuleLogic<sub>INCLUDE</sub><sub>DIRS</sub>="
       #$slicer-subjecthierarchy-5.8
...
(define-public slicer-markups-5.8
  (make-slicer-loadable-module
   ...
   #:patches (list "markups/0001-ENH-Add-standalone-build-support-for-Markups-module.patch"
                   ...
                   "markups/0005-ENH-Add-LINK<sub>DIRECTORIES</sub>-to-module-logic-build.patch"
...
the Slicer source tree."
   ...
   #~(list
      ...
      (string-append "-DRapidJSON<sub>DIR</sub>="
                     #$rapidjson
                     "/lib/cmake/RapidJSON")
...
@file{Modules/Loadable/Volumes} subtree of the Slicer source tree."
   ...
   #~(list
      ...
      ;; qSlicerVolumesModuleWidget.ui → ui<sub>qSlicerVolumesModuleWidget.h</sub>).
      (string-append
       "-DqSlicerColorsModuleWidgets<sub>INCLUDE</sub><sub>DIRS</sub>="
       #$slicer-colors-5.8
       "/include/Slicer-5.8/qt-loadable-modules/qSlicerColorsModuleWidgets")
...
;;   -DSlicer<sub>BUILD</sub><sub>CLI</sub>:BOOL=OFF
;;   -DSlicer<sub>BUILD</sub><sub>CLI</sub><sub>SUPPORT</sub>:BOOL=OFF
...
;;      CropInterpolated body with #ifdef Slicer<sub>BUILD</sub><sub>CLI</sub><sub>SUPPORT</sub>, making
...
;;       (string-append
;;        "-DvtkSlicerVolumesModuleLogic<sub>INCLUDE</sub><sub>DIRS</sub>="
;;        #$slicer-volumes-5.8
...
;;       (string-append
;;        "-DvtkSlicerMarkupsModuleMRML<sub>INCLUDE</sub><sub>DIRS</sub>="
;;        #$slicer-markups-5.8
...
(define-public slicer-data-5.8
  (make-slicer-loadable-module
   ...
   #:patches (list "data/0001-ENH-Add-standalone-CMake-build-support-for-Data-modu.patch"
                   "data/0002-COMP-Add-LINK<sub>DIRECTORIES</sub>-for-external-module-librar.patch")
...
subtree of the Slicer source tree."
   ...
   #:extra-configure-flags
   #~(list
      ;; Cameras Logic include directory: replaces \_SOURCE<sub>DIR</sub> + \_BINARY<sub>DIR</sub>.
      (string-append
       "-DvtkSlicerCamerasModuleLogic<sub>INCLUDE</sub><sub>DIRS</sub>="
       #$slicer-cameras-5.8
...
(define-public slicer-sequences-5.8
  (make-slicer-loadable-module
   ...
   #:patches (list "sequences/0001-ENH-Add-standalone-CMake-build-support-for-Sequences.patch"
                   ...
                   "sequences/0003-COMP-Guard-DesignerPlugins-subdirectory-with-Slicer<sub>.patch</sub>")
...
(define-public slicer-segmentations-5.8
  (make-slicer-loadable-module
   ...
   #:patches (list "segmentations/0001-ENH-Add-standalone-CMake-build-support-for-Segmentat.patch"
                   ...
                   "segmentations/0003-COMP-Fix-Slicer<sub>BINARY</sub><sub>DIR</sub>-in-SegmentEditorEffects-f.patch"
...
@file{Modules/Loadable/VolumeRendering} subtree of the Slicer source tree."
   ...
   #~(list
      ...
      (string-append
       ...
       "/include/Slicer-5.8/qt-loadable-modules/vtkSlicerMarkupsModuleMRML")
      (string-append
       "-DqSlicerMarkupsModuleWidgets<sub>INCLUDE</sub><sub>DIRS</sub>="
       #$slicer-markups-5.8
       "/include/Slicer-5.8/qt-loadable-modules/qSlicerMarkupsModuleWidgets")
      (string-append
       "-DqSlicerVolumesSubjectHierarchyPlugins<sub>INCLUDE</sub><sub>DIRS</sub>="
       #$slicer-volumes-5.8
...
;; these install python scripts to lib/slicer-5.8/qt-scripted-modules/.
;;
...
(define* (make-slicer-scripted-module
  ...
  (package
   ...
   ;; we start from slicer-5.8's inputs and prepend slicer-5.8
   ...
   (inputs (fold (lambda (pkg acc)
                 ...
                 (modify-inputs (package-inputs slicer-5.8)
                   (prepend slicer-5.8))
                 extra-inputs))
   ;; Propagate slicer-5.8 so "guix shell slicer-<name>-5.8" provides
...
(define-public slicer-all-5.8
  (package
    ...
    (propagated-inputs
     ;; Python runtime packages live here (not in slicer-5.8) so that
     ;; &#x2013;without-tests transforms on any of them do not cascade into every
     ;; loadable module derivation and cause duplicate builds.
     ;; vtk-slicer, ctk, vtkaddon are already transitively present via
