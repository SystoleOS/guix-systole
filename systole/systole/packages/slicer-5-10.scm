...
;;
(define-module (systole packages slicer-5-10)
...
;; slicer-factory), with the 5.10 base package, version string, and PythonQt
;; pre-applied.  Keyword arguments are passed through unchanged.

(define (make-slicer-loadable-module-5.10 . args)
  (apply factory:make-slicer-loadable-module
         #:slicer slicer-5.10
         #:slicer-version "5.10"
         #:pythonqt pythonqt-commontk-for-slicer-5.10
         args))

(define (make-slicer-scripted-module-5.10 . args)
